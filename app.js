...
app.delete('/v1/saep/produto/:id', async function(request, response) {
    const id = request.params.id;
...
// Rotas para Estoque
app.get('/v1/saep/estoques', async function(request, response) {
    const dados = await estoqueController.listarProdutos();
    response.status(dados.status_code).json(dados);
});

app.post('/v1/saep/estoque', async function(request, response) {
    const contentType = request.headers['content-type'];
...
app.get('/v1/saep/fabricantes', async function(request, response) {
    const dados = await fabricanteController.listarFabricantes();
    response.status(dados.status_code).json(dados);
});

app.get('/v1/saep/fabricante/:id', async function(request, response) {
    const id = request.params.id;
    const dados = await fabricanteController.buscarFabricantePorId(id);
    response.status(dados.status_code).json(dados);
});

app.post('/v1/saep/fabricante', async function(request, response) {
    const contentType = request.headers['content-type'];
    const dados = await fabricanteController.inserirFabricante(request.body, contentType);
    response.status(dados.status_code).json(dados);
});

app.put('/v1/saep/fabricante/:id', async function(request, response) {
    const id = request.params.id;
    const contentType = request.headers['content-type'];
...
app.delete('/v1/saep/fabricante/:id', async function(request, response) {
    const id = request.params.id;
...
app.get('/v1/saep/categorias', async function(request, response) {
    const dados = await categoriaController.listarCategorias();
    response.status(dados.status_code).json(dados);
});

app.get('/v1/saep/categoria/:id', async function(request, response) {
    const id = request.params.id;
    const dados = await categoriaController.buscarCategoriaPorId(id);
    response.status(dados.status_code).json(dados);
});

app.post('/v1/saep/categoria', async function(request, response) {
    const contentType = request.headers['content-type'];
    const dados = await categoriaController.inserirCategoria(request.body, contentType);
    response.status(dados.status_code).json(dados);
});

app.put('/v1/saep/categoria/:id', async function(request, response) {
    const id = request.params.id;
    const contentType = request.headers['content-type'];
...
app.delete('/v1/saep/categoria/:id', async function(request, response) {
    const id = request.params.id;
...
app.delete('/v1/saep/ficha-tecnica/:id', async function(request, response) {
    const id = request.params.id;
